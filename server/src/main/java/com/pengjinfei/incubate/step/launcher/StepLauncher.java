...
public interface StepLauncher {
    ...
    <T extends Serializable> StepContext launch(StepChain<T> chain, T params) throws Exception;

    <T extends Serializable> StepContext launch(String chainName, T params) throws Exception;
}
